...
class ImageUploadHandlerRequest extends BaseRequest
{
    public function rules()
    {
        return [
            ...
            'filename' => [
                'required',
                Rule::in(['companies', 'articles', 'hotels', 'rooms', 'attractions', 'services', 'slideshows']),
            ],
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'filename.in'       => '图片上传文件目录只能是 [companies, articles, hotels, rooms, attractions, services, slideshows] 数组中的任一值',
        ];
    }
}
